...
class tplink():
    ...
    def __init__(self):
        ...
        self.mapping = [['voltage', 'Voltage', 'mV', 'I', 0.001, 0, 'voltage_mv'],
                   ['current', 'Current', 'mA', 'I', 0.001, 0, 'current_ma'],
                   ['power', 'Power', 'mW', 'I', 0.001, 0, 'power_mw'],
                   ['total', 'Total energy', 'Wh', 'I', 0.001, 0, 'total_wh'],
                   ['relay', 'Relay state', '', 'b', 1, 0, 'relay_state']]
    ...
    def poll(self):
        ...
        for row in self.mapping:
            (name, descr, unit, datatype, scale, offset, key) = row
            scale = float(scale)
